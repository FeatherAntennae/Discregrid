...
namespace Discregrid
{
    ...
    TriangleMesh::TriangleMesh(float const *vertices,
    ...
    TriangleMesh::construct()
    {
        ...
        {
            std::cout << std::endl
                      << "WARNING: Mesh not closed!" << std::endl;
        }
    }
    ...
    {
        Vector3f const &x0 = vertex(faceVertex(f, 0));
        Vector3f const &x1 = vertex(faceVertex(f, 1));
        Vector3f const &x2 = vertex(faceVertex(f, 2));
